...
import { filterFactory, filterTwoFactory, productMinPrice, userFilter } from "services/filter.service";
import { handleAddProductToCart, handleCountTotalProductClientPage, handleDeleteCartDetail, handleGetAllProducts, handleGetDetailProduct, handleGetProductInCart, handlePlaceOrder, updateCartDetailBeforeCheckout } from "services/item.service";
...
export { getDetailProduct, postProductToCart, getCartPage, postDeleteCardDetail, 
    getCheckoutPage, postToCheckout, postPlaceOrder, getThanksPage,
