...
import { handleCountTotalProductClientPage, handleGetAllProducts } from "services/item.service";
import { handleCreateUser, handleGetAllUser, handleDeleteUser, handleGetUser, handleUpdateUser, handleGetAllRole } from "services/user.service";
...
const getProductFilterPage = async (req: Request, res: Response) => {
    ...
    const data = await handleGetProductWithFilter(currentPage, 6, factory, target, price, sort)
...
export { getHomePage, getCreateUserPage, postCreateUser, postDeleteUser, getViewUser, 
    postUpdateUser, getLoginPage, getRegisterPage, postRegisterPage, 
    getSuccessLoginPage, postLogout, getProductFilterPage };